...
int doAimAssist() {
	...
	std::cout << "\n WhyAimLMAO is laucnched and running at\n";
	std::cout << " Range: " << range << "\n";
	std::cout << " FOV: " << fov << "\n";
	std::cout << " Strenght: " << overallSpeed << "\n";
...
int main()
{
	SetConsoleTitle(L"9jaPFZ7v5C");

	SetPriorityClass(GetCurrentProcess(), BELOW_NORMAL_PRIORITY_CLASS);

	std::cout << "\n [+]You're using external aimbot by (C) Ragecore Technolgy, sate of the art concept.\n\n\n PRESS ENTER TO START" << std::endl;
